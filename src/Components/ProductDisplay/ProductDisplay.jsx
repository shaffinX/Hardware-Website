...
function ProductDisplayN({AddToCart}) {
    ...
    function getData(){
        const reference = ref(database,`${category}/${partno}`)
      ...
      <MediaQuery minWidth={1000}>
        <Container>
          ...
          <Row>
            ...
            <Col>
                <a href={`/Product-Category/${category}`}><h5>Product-Category / {category}</h5></a>
...
export default ProductDisplayN
